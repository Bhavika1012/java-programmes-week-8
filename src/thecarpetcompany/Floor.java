 ...
 */
public class Floor {
    public double width; //instance variables with double type
    public double length;

    public Floor(double width, double length) { //constructor method with params
        this.width = (width < 0) ? 0 : width;//initialising variables
        this.length = (length < 0) ? 0: length;
    }
    public double getArea(){ //method without params
        return width * length; //returning double variable
    }
}
